...
extension JWT {
     ...
     */
    static public func encode(claims: ClaimSet, algorithm: Algorithm, headers: [String: String]? = nil) -> String {
    ...
    /*** Encode a dictionary of claims
     ...
     - returns: The JSON web token as a String
     */
    static public func encode(claims: [String: Any], algorithm: Algorithm, headers: [String: String]? = nil) -> String {
    ...
    static public func encode(_ algorithm: Algorithm, closure: ((ClaimSetBuilder) -> Void)) -> String {
    ...
    static public func encode(_ payload: Payload, algorithm: Algorithm) -> String {
